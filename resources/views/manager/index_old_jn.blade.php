        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="{{ route('index_jn_manager') }}">Job Number Table</a></li>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                      <h3 class="card-title">Old Job Number Data</h3>
                        ...
                        <tbody>
                            @foreach ($jn_data as $item)
                                <tr>
                                    ...
                                    <td>{{ $item->pic }}</td>
                                    <td>
                                      <a href="javascript:void(0)" id="show-data" data-url="{{ route('show_jn_old_manager',$item->id_jn) }}" class="btn btn-default"><i class="far fa-eye"></i></a>                                       
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
