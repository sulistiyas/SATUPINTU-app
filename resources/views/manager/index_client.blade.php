...
@include('manager.includes.sidebar')
  ...
  <div class="content-wrapper">
                        ...
                        <tbody>
                            @foreach ($client_data as $item)
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <a href="javascript:void(0)" id="show-data" data-url="{{ route('show_client_manager',$item->id_client) }}" class="btn btn-default"><i class="far fa-eye">&nbsp;</i></a>
                                        </div>
    ...
    {{-- End Content --}}
    {{-- Create Modal --}}
    <form action="{{ route('store_client_manager') }}" method="POST" enctype="multipart/form-data" id="client" name="client">
        @csrf
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="update_txt_comp_name" id="update_txt_comp_name" class="form-control" placeholder="Company Name" @readonly(true) >
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                                <label for="update_txt_comp_add">Company Address</label>
                                <input type="text" name="update_txt_comp_add" id="update_txt_comp_add" class="form-control" placeholder="Company Address" @readonly(true) >
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="number" name="update_txt_comp_npwp" id="update_txt_comp_npwp" class="form-control" placeholder="NPWP" @readonly(true)>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                                <label for="update_txt_comp_npwp_add">NPWP Address</label>
                                <input type="text" name="update_txt_comp_npwp_add" id="update_txt_comp_npwp_add" class="form-control" placeholder="NPWP Address" @readonly(true)>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="update_txt_comp_kota" id="update_txt_comp_kota" class="form-control" placeholder="Kota" @readonly(true) >
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                                <label for="update_txt_comp_kode_pos">Kode Pos</label>
                                <input type="number" name="update_txt_comp_kode_pos" id="update_txt_comp_kode_pos" class="form-control" placeholder="Kode Pos" @readonly(true)>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="update_txt_comp_name_up" id="update_txt_comp_name_up" class="form-control" placeholder="Nama UP" @readonly(true) >
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                                <label for="update_txt_jbt_comp_up">Jabatan UP</label>
                                <input type="text" name="update_txt_jbt_comp_up" id="update_txt_jbt_comp_up" class="form-control" placeholder="Jabatan UP" @readonly(true)>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="number" name="update_txt_phone_comp" id="update_txt_phone_comp" class="form-control" placeholder="Phone" @readonly(true) >
                            </div>
                        </div>
                    </div>
                </div>
