    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="{{ Request::routeIs('index_pr_admin') || Request::routeIs('index_po_admin') || Request::routeIs('index_vendor_admin') || Request::routeIs('create_pr_admin') || Request::routeIs('epurchase_report_index') || Request::routeIs('index_old_prpo')? 'nav-item menu-open' : 'nav-item menu' }}">
            <a href="#"  class="{{ Request::routeIs('index_pr_admin') || Request::routeIs('index_po_admin') || Request::routeIs('index_vendor_admin') || Request::routeIs('create_pr_admin') || Request::routeIs('epurchase_report_index') || Request::routeIs('index_old_prpo')? 'nav-link active' : 'nav-link' }}">
