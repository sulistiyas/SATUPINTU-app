    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="{{ Request::routeIs('index_jn_users') || Request::routeIs('index_client_users') || Request::routeIs('index_jn_old_users') ? 'nav-item menu-open' : 'nav-item menu' }}">
            <a href="#"  class="{{ Request::routeIs('index_jn_users') || Request::routeIs('index_client_users') || Request::routeIs('index_jn_old_users') ? 'nav-link active' : 'nav-link' }}">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{ route('index_jn_old_users') }}" class="{{ Request::routeIs('index_jn_old_users') ? 'nav-link active' : 'nav-link' }}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Old Job Number</p>
                </a>
              </li>
