...
<div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="{{ route('index_pr_users') }}">PR Table</a></li>
    ...
    <section class="content">
        <form action="{{ route('store_pr_users') }}" method="POST" enctype="multipart/form-data" id="create_pr" name="create_pr">
            @csrf
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <button type="button" class="btn btn-outline-primary" title="Refresh Data" id="refresh_number" data-url="{{ route('refresh_pr_users')}}">
                        ...
                        <div class="card">
                            ...
                            <div class="card-footer">
                                <div class="row">
                                    ...
                                    <div class="col-3">
                                        <div class="form-group">
                                            <a href="{{ route('index_pr_users') }}" class="form-control btn btn-danger">Cancel</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
