...
@include('users.includes.sidebar')
  ...
  <div class="content-wrapper">
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu" role="menu" style="">
                                                <form onsubmit="return confirm('Apakah Anda Yakin ingin Menghapus data ?');" action="{{ route('destroy_client_users',[$item->id_client]) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                    <a href="javascript:void(0)" id="show-data" data-url="{{ route('edit_client_users',$item->id_client) }}" class="dropdown-item"><i class="fas fa-pencil-alt"> Update</i></a>
    ...
    {{-- End Content --}}
    {{-- Create Modal --}}
    <form action="{{ route('store_client_users') }}" method="POST" enctype="multipart/form-data" id="client" name="client">
        @csrf
    ...
    {{-- End Create --}}
    {{-- Update Modal --}}
    <form action="{{ route('update_client_users',$item->id_client) }}" method="POST" enctype="multipart/form-data" id="update_client_form" name="update_client_form">
        @csrf
