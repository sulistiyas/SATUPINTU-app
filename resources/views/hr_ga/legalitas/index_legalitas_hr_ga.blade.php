...
<div class="content-wrapper">
                                    ...
                                    @foreach ($legalitas_office as $item_legalitas)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <div class="col-md-5">
                                                        <button type="button" class="btn btn-outline-primary" title="Show Data" data-toggle="modal" data-target="#modal_legalitas_show" id="get_legalitas" data-url="{{ route('show_modal_pr_hr_ga',['id'=>$item_legalitas->id_legalitas])}}"><i class="fas fa-eye"></i></button>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <button type="button" class="btn btn-outline-warning" title="Edit Data" data-toggle="modal" data-target="#modal_legalitas_edit" id="edit_legalitas" data-url="{{ route('edit_office_legalitas_hr_ga',['id'=>$item_legalitas->id_legalitas])}}"><i class="fas fa-pen"></i></button>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
    ...
    {{-- Create Modal --}}
    <form action="{{ route('store_office_legalitas_hr_ga') }}" method="POST" enctype="multipart/form-data" id="legalitas_office" name="legalitas_office">
        @csrf
    ...
    {{-- End Create --}}
    {{-- Update Modal --}}
    <form action="{{ route('update_office_legalitas_hr_ga') }}" method="POST" enctype="multipart/form-data" id="legalitas_office_update" name="legalitas_office_update">
        @csrf
