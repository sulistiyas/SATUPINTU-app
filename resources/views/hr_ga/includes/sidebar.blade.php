        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="{{ Request::routeIs('index_jn_hr_ga') || Request::routeIs('index_client_hr_ga') || Request::routeIs('index_jn_old_hr_ga') || Request::routeIs('index_jn_2018') || Request::routeIs('index_jn_2019') || Request::routeIs('index_jn_2020') || Request::routeIs('index_jn_2021') || Request::routeIs('index_jn_2022') || Request::routeIs('index_jn_2023') || Request::routeIs('index_jn_2024') ? 'nav-item menu-open' : 'nav-item menu' }}">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ route('index_client_hr_ga') }}" class="{{ Request::routeIs('index_client_hr_ga') ? 'nav-link active' : 'nav-link' }}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Client</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('index_jn_hr_ga') }}" class="{{ Request::routeIs('index_jn_hr_ga') ? 'nav-link active' : 'nav-link' }}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Job Number List</p>
                </a>
              </li>
          ...
          <li class="{{ Request::routeIs('index_pr_hr_ga') || Request::routeIs('index_po_hr_ga') || Request::routeIs('index_vendor_hr_ga') || Request::routeIs('create_pr_hr_ga') || Request::routeIs('epurchase_report_index') || Request::routeIs('index_old_prpo')? 'nav-item menu-open' : 'nav-item menu' }}">
            <a href="#"  class="{{ Request::routeIs('index_pr_hr_ga') || Request::routeIs('index_po_hr_ga') || Request::routeIs('index_vendor_hr_ga') || Request::routeIs('create_pr_hr_ga') || Request::routeIs('epurchase_report_index') || Request::routeIs('index_old_prpo')? 'nav-link active' : 'nav-link' }}">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ route('index_pr_hr_ga') }}" class="{{ Request::routeIs('index_pr_hr_ga') || Request::routeIs('create_pr_hr_ga') ? 'nav-link active' : 'nav-link' }}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Purchase Request</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('index_po_hr_ga') }}" class="{{ Request::routeIs('index_po_hr_ga') || Request::routeIs('create_po_hr_ga') ? 'nav-link active' : 'nav-link' }}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Purchase Order</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="{{ route('index_vendor_hr_ga') }}" class="{{ Request::routeIs('index_vendor_hr_ga') ? 'nav-link active' : 'nav-link' }}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Vendor</p>
                </a>
              </li>
          ...
          <li class="{{ Request::routeIs('index_furniture') || Request::routeIs('index_atk_master_hr_ga') || Request::routeIs('index_atk_in_hr_ga') ||  Request::routeIs('index_atk_request_hr_ga') || Request::routeIs('index_office_legalitas_hr_ga') || Request::routeIs('index_letter_number') || Request::routeIs('index_users') || Request::routeIs('index_letter_2018') || Request::routeIs('index_letter_2019') || Request::routeIs('index_letter_2020') || Request::routeIs('index_letter_2021') || Request::routeIs('index_letter_2022') || Request::routeIs('index_letter_2023') || Request::routeIs('index_letter_2024')? 'nav-item menu-open' : 'nav-item menu' }}">
            ...
            <ul class="nav nav-treeview">
              <li class="{{ Request::routeIs('index_furniture') || Request::routeIs('index_atk_master_hr_ga') || Request::routeIs('index_atk_in_hr_ga') || Request::routeIs('index_atk_request_hr_ga') ? 'nav-item menu-open' : 'nav-item menu' }}">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="{{ route('index_furniture') }}" class="{{ Request::routeIs('index_furniture') ? 'nav-link active' : 'nav-link' }}">
                      <i class="far fa-dot-circle nav-icon"></i>
                      <p>Furniture</p>
                    </a>
                  </li>
                  <li class="{{ Request::routeIs('index_atk_master_hr_ga') || Request::routeIs('index_atk_in_hr_ga') || Request::routeIs('index_atk_request_hr_ga')? 'nav-item menu-open' : 'nav-item menu' }}">
                    ...
                    <ul class="nav nav-treeview">
                      <li class="nav-item">
                        <a href="{{ route('index_atk_master_hr_ga') }}" class="{{ Request::routeIs('index_atk_master_hr_ga') ? 'nav-link active' : 'nav-link' }}">
