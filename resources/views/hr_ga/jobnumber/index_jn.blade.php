          ...
          <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                      <table id="tbl_jn" class="table table-bordered table-striped" style="overflow: auto">
                        <thead>
                            <tr>
                                <th>No.</th>
                                <th>Job Number</th>
                  ...
                  <div class="row">
                    ...
                    <div class="col-1">
                      <div class="form-group">
                        ...
                        <a href="javascript:void(0)" id="btn_refresh_jn" name="btn_refresh_jn" class="btn btn-warning form-control" data-url="{{ route('refresh_jn_hr_ga') }}">
